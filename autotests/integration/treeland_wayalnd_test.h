// Copyright (C) 2026 WenHao Peng <pengwenhao@uniontech.com>.
// SPDX-License-Identifier: Apache-2.0 OR LGPL-3.0-only OR GPL-2.0-only OR GPL-3.0-only

#ifndef TREELAND_WAYLAND_TEST_H
#define TREELAND_WAYLAND_TEST_H
...
class WaylandTestApplication : public Treeland
{
    Q_OBJECT
public:
