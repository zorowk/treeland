...
void SurfaceProxy::setSurface(SurfaceWrapper *newSurface)
{
    ...
    if (m_sourceSurface) {
        ...
        m_sourceConnections << connect(m_sourceSurface,
                                       ...
                                       this,
                                       &SurfaceProxy::updateDecoration);
        m_sourceConnections << connect(m_sourceSurface,
                                       &SurfaceWrapper::noCornerRadiusChanged,
                                       this,
                                       &SurfaceProxy::updateCornerRadius);
...
void SurfaceProxy::updateTitleBar()
{
    m_proxySurface->setNoTitleBar(m_sourceSurface->noTitleBar());
}

void SurfaceProxy::updateDecoration()
{
    m_proxySurface->setNoDecoration(m_fullProxy ? m_sourceSurface->noDecoration() : true);
}

void SurfaceProxy::updateCornerRadius()
{
