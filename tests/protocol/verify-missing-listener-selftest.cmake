...
if(selftest_result EQUAL 0)
    message(FATAL_ERROR "Missing-listener self-test unexpectedly passed")
endif()
if(NOT EXISTS "${summary_file}")
    message(FATAL_ERROR "Missing-listener self-test did not write summary.json")
endif()
...
if(NOT result STREQUAL "fail")
    message(FATAL_ERROR "Missing-listener self-test summary result is not fail")
endif()
if(NOT failure_category STREQUAL "checkpoint_event_diff")
    message(FATAL_ERROR
        "Missing-listener category is '${failure_category}', expected checkpoint_event_diff")
endif()

message(STATUS "Missing-listener self-test failed with checkpoint_event_diff as expected")
