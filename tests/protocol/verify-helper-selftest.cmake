...
if(selftest_result EQUAL 0)
    message(FATAL_ERROR "Wrong-Helper-state self-test unexpectedly passed")
endif()
if(NOT EXISTS "${summary_file}")
    message(FATAL_ERROR "Wrong-Helper-state self-test did not write summary.json")
endif()
...
if(NOT result STREQUAL "fail")
    message(FATAL_ERROR "Wrong-Helper-state self-test summary result is not fail")
endif()
if(NOT failure_category STREQUAL "checkpoint_probe_diff")
    message(FATAL_ERROR
        "Wrong-Helper-state category is '${failure_category}', expected checkpoint_probe_diff")
endif()

message(STATUS "Wrong-Helper-state self-test failed with checkpoint_probe_diff as expected")
