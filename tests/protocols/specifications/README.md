...
| [input-manager-unstable-v1](input-manager-unstable-v1.md) | I / E（可选） | 默认空设备 manager 生命周期；uinput 驱动真实 libinput capability 热插拔 |
| [keyboard-state-notify-unstable-v1](keyboard-state-notify-unstable-v1.md) | P | watcher 配置与空键盘/空 modifier 边界 |
...
| [wallpaper desktop 联合路径](wallpaper-desktop-v1.md) | P / E | manager 配置、shell surface 与真实 output 的关联 |
