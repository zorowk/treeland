...
| --- | --- | --- | --- |
| 初始 output 描述 | bind manager v4 并 roundtrip | 一个 head、`name`、`description`、virtual mode 的 `size/refresh`、`current_mode`、`enabled`、`position`、`transform`、`scale`、`adaptive_sync` 与携带 serial 的 `done` | P |
